	...
	class CANON_SIDEBAR_TEMPLATE extends WP_Widget {
		...
		***************************************/
		function __construct () {
				...
				$widget_ops = array(
					...
					'description' => __('YOUR STANDARD TEMPLATE BANNER', "loc_sport_widgets_plugin")	 				
				);
				$control_ops = array(
					'width' => 300, 
					'height' => 350, 
				...
				parent::__construct('CANON_SIDEBAR_TEMPLATE', __('TEMPLATE_DISPLAY_TITLE', "loc_sport_widgets_plugin"), $widget_ops, $control_ops );	
		}
		...
		***************************************/
		function form($instance) {
			...
			<!-- SELECT -->	
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('display_style')); ?> "><?php _e("Display style", "loc_sport_widgets_plugin"); ?>	: </label><br>
