		...
		?>
			...
			<li class="building_block block_carousel block_group_functionality">
				...
				<div class="block_header">
					<?php _e("Carousel", "loc_sport_core_plugin"); ?>
					<span class="block-edit"></span>
				</div>

				<div class="block_options">

					<input class='block_option' type="hidden" id='block_type' name='canon_options_pagebuilder[blocks][<?php echo $index; ?>][type]' value='carousel'>
				...
				<!-- BLOCK TAB: GENERAL -->
					...
					<!-- DYNAMIC SELECT -->
						<?php 
						 ...
						 ?>
						<div class="option">
							<label><?php _e("Show", "loc_sport_core_plugin"); ?></label>
							<select class='block_option' id="show" name="canon_options_pagebuilder[blocks][<?php echo $index; ?>][show]"> 
				     			<option value="latest_posts" <?php if (isset($params['show'])) {if ($params['show'] == "latest_posts") echo "selected='selected'";} ?>><?php _e("Latest posts", "loc_sport_core_plugin"); ?></option> 
				     			<option value="random_posts" <?php if (isset($params['show'])) {if ($params['show'] == "random_posts") echo "selected='selected'";} ?>><?php _e("Random posts", "loc_sport_core_plugin"); ?></option> 
				     			<option value="latest_posts"></option> 

				     			<option value="popular_views" <?php if (isset($params['show'])) {if ($params['show'] == "popular_views") echo "selected='selected'";} ?>><?php _e("Popular posts by views", "loc_sport_core_plugin"); ?>	</option> 
			 					<option value="popular_comments" <?php if (isset($params['show'])) {if ($params['show'] == "popular_comments") echo "selected='selected'";} ?>><?php _e("Popular posts by comments", "loc_sport_core_plugin"); ?>	</option> 
				     			<option value="latest_posts"></option> 
					...
					<!-- SELECT -->
						<div class="option">
							<label><?php _e("Layout", "loc_sport_core_plugin"); ?></label>
							<select class='block_option' id="layout" name="canon_options_pagebuilder[blocks][<?php echo $index; ?>][layout]"> 
				     			<option value="boxed" <?php if (isset($params['layout'])) {if ($params['layout'] == "boxed") echo "selected='selected'";} ?>><?php _e("Boxed", "loc_sport_core_plugin"); ?></option> 
				     			<option value="full" <?php if (isset($params['layout'])) {if ($params['layout'] == "full") echo "selected='selected'";} ?>><?php _e("Full Width", "loc_sport_core_plugin"); ?></option> 
							</select> 
						</div>
						
					<!-- SELECT -->
						<div class="option">
							<label><?php _e("Featured images link to", "loc_sport_core_plugin"); ?></label>
							<select class='block_option' id="link_to" name="canon_options_pagebuilder[blocks][<?php echo $index; ?>][link_to]"> 
				     			<option value="post" <?php if (isset($params['link_to'])) {if ($params['link_to'] == "post") echo "selected='selected'";} ?>><?php _e("Posts", "loc_sport_core_plugin"); ?></option> 
				     			<option value="lightbox" <?php if (isset($params['link_to'])) {if ($params['link_to'] == "lightbox") echo "selected='selected'";} ?>><?php _e("Lightbox", "loc_sport_core_plugin"); ?></option> 
							</select> 
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Show section header", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Show featured image", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Show publish date", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Show title", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Show excerpt", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Show more link", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- NUMBER -->
						<div class="option">
							...
							><?php _e("Number of items to display", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- NUMBER -->
						<div class="option">
							...
							><?php _e("Number of items to load", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- NUMBER -->
						<div class="option">
							...
							><?php _e("Slide speed", "loc_sport_core_plugin"); ?> <i>(<?php _e("milliseconds", "loc_sport_core_plugin"); ?>)</i>
						</div>
					...
					<!-- NUMBER -->
						<div class="option">
							...
							><?php _e("Autoplay speed ", "loc_sport_core_plugin"); ?> <i>(<?php _e("milliseconds - 0 to turn autoplay off", "loc_sport_core_plugin"); ?>)</i>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Stop on hover", "loc_sport_core_plugin"); ?>
						</div>
					...
					<!-- CHECKBOX -->
						<div class="option">
							...
							<?php _e("Pagination", "loc_sport_core_plugin"); ?>
						</div>
